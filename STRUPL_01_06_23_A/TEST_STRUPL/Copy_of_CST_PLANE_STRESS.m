...
[delta,Reaction,node_displacement,SIGMA,STRAIN]=Elastic_solve(KK,fg,nf,dee,bee);
...
%crack_path=[];% this vector is the former IL vector from manuela and franchi codes is formed by 1st column prone crack nodes and 2dn column is the length 
...
Resistance_cracking = zeros(2*2*size(crack_path(:,1),1),1) ;
for rr = 1 : size(RR,1)
